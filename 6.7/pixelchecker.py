...
print(pixelartlen)
print(brushartlen)
print('Loading the functions and modules took {:.2f} seconds. The first image took {:.2f} seconds, the second image took {:.2f} seconds, the third image took {:.2f} seconds, and in total it took {:.2f} seconds.'.format(t1-t0, t2-t1, t3-t2, t4-t3, t4-t0))